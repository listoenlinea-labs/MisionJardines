...
cat > docs/assets/js/navigation-drawer.js <<'EOF'
(() => {
  const init = () => {
...
pages = [
    'docs/index.html', 'docs/cuotas.html', 'docs/bases_datos.html',
    'docs/mapa.html', 'docs/visitas.html', 'docs/seguridad.html',
    'docs/calendario.html', 'docs/reportes.html', 'docs/directorio.html'
]
marker = '<script src="assets/js/navigation-drawer.js?v=1"></script>'
...
rm -f .github/workflows/apply-navigation-drawer.yml
rm -f scripts/apply-navigation-drawer.sh
